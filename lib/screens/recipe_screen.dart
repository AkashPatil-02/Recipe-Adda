...
class RecipeCard extends StatefulWidget {
  ...
  final File image;
  const RecipeCard({super.key, required this.recipe, required this.image});
...
class _RecipeCardState extends State<RecipeCard> {
  ...
  void _toggleBookmark() {
    if (_isBookmarked) return; // prevent duplicate saves

    final id = _hive.writeData(widget.image, widget.recipe);

    setState(() => _isBookmarked = true);

    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: const Text('Recipe bookmarked!'),
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            icon: Icon(
              _isBookmarked ? Icons.bookmark : Icons.bookmark_add,
